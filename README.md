...
## 📥 Descargas (Versión v0.3.1)

Descarga directa de los binarios autónomos (sin necesidad de tener Node.js instalado) desde la [Release v0.3.1](https://github.com/Oloxx/drop/releases/tag/v0.3.1):

* **Windows (x64):** [`drop-v0.3.1-windows-x64.exe`](https://github.com/Oloxx/drop/releases/download/v0.3.1/drop-v0.3.1-windows-x64.exe)
* **Linux (x64):** [`drop-v0.3.1-linux-x64.tar.gz`](https://github.com/Oloxx/drop/releases/download/v0.3.1/drop-v0.3.1-linux-x64.tar.gz)
* **Linux (ARM64):** [`drop-v0.3.1-linux-arm64.tar.gz`](https://github.com/Oloxx/drop/releases/download/v0.3.1/drop-v0.3.1-linux-arm64.tar.gz) *(Raspberry Pi, VPS Oracle ARM, AWS Graviton)*
* **macOS (Apple Silicon):** [`drop-v0.3.1-macos-arm64.tar.gz`](https://github.com/Oloxx/drop/releases/download/v0.3.1/drop-v0.3.1-macos-arm64.tar.gz) *(M1, M2, M3, M4)*
* **macOS (Intel):** [`drop-v0.3.1-macos-x64.tar.gz`](https://github.com/Oloxx/drop/releases/download/v0.3.1/drop-v0.3.1-macos-x64.tar.gz)
...
### Windows
Simplemente **descarga [`drop-v0.3.1-windows-x64.exe`](https://github.com/Oloxx/drop/releases/download/v0.3.1/drop-v0.3.1-windows-x64.exe) y haz doble clic sobre él**.
...
```bash
tar -xzf drop-v0.3.1-linux-x64.tar.gz
./drop-v0.3.1-linux-x64 install
```
